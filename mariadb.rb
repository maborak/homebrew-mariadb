class Mariadb < Formula
  desc "MariaDB to be used as Multiple MySQL instances"
  ...
  def install
    ...
    inreplace "scripts/mysql_install_db.sh" do |s|
      ...
      s.change_make_var! "ldata", "\"#{var}/mariadb_mysql\""
    end

    # -DINSTALL_* are relative to prefix
    args = %W[
      -DMYSQL_DATADIR=#{var}/mariadb_mysql
  ...
  def plist; <<-EOS.undent
    ...
    <dict>
      ...
      <array>
        ...
        <string>--defaults-file=/usr/local/etc/mariadb.cnf</string>
      </array>
      <key>RunAtLoad</key>
      <true/>
